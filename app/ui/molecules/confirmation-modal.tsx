...
const variantStyles: Record<ConfirmationVariant, { icon: React.ReactNode; bg: string; btn: 'red' | 'outline' | 'blue' | 'black' }> = {
  danger: {
  ...
  warning: {
    ...
    bg: 'bg-yellow-100',
    btn: 'black', // Using black instead of a non-existent yellow variant
  },
  info: {
      ...
      <Container className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="p-6 text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Btn variant="outline" size="md" onClick={onCancel} className="flex-1">
              {cancelText}
            </Btn>

...
export interface ProfileAboutTemplateProps {
  stats: { label: string; value: string; icon: ReactNode }[];
  vision: string;
  missions: string[];
}

export function ProfileAboutTemplate({ stats, vision, missions }: ProfileAboutTemplateProps) {
  return (
    <Container className="min-h-screen bg-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative h-64 md:h-96 rounded-3xl overflow-hidden mb-12 shadow-2xl">
          <Image src="/images/landing-3.png" alt="YAMUTI Background" fill className="object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-8 md:p-12">
            <Txt weight="bold" className="text-white text-4xl md:text-5xl">
              Tentang YAMUTI
            </Txt>
            <Txt className="text-white/80 text-lg mt-2">
              Yayasan Mutiara Ummat Indonesia - Menebar Kebaikan, Menggapai Berkah
            </Txt>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6">
            <Txt variant="h3" weight="bold" className="text-2xl text-red-primary">
              Visi Kami
            </Txt>
            <Txt className="text-gray-600 leading-relaxed text-lg">{vision}</Txt>
          </div>
          <div className="space-y-6">
            <Txt variant="h3" weight="bold" className="text-2xl text-red-primary">
              Misi Kami
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="flex flex-col items-center text-center p-6 rounded-2xl bg-gray-50 border border-gray-100">
              ...
              <Txt weight="bold" className="text-2xl text-gray-900">
                {stat.value}
              </Txt>
        ...
        <div className="bg-red-50 p-8 md:p-12 rounded-3xl text-center border border-red-100">
          <Txt variant="h3" weight="bold" className="text-2xl text-red-primary mb-4">
...
export const ABOUT_STATS_DEFAULT = [
